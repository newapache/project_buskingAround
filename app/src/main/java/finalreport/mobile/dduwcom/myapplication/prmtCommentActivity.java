...
public class prmtCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post = (PostPromote) getIntent().getSerializableExtra("post");
        ...
        mLayoutManager = new LinearLayoutManager(prmtCommentActivity.this);
...
//        commentRecyclerView.setAdapter(commentAdapter);
        ...
        FirebaseDatabase.getInstance().getReference("comments").child(post.getPostPrmt_postID()).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void sendComment() {
        final ProgressDialog progressDialog = new ProgressDialog(prmtCommentActivity.this);
