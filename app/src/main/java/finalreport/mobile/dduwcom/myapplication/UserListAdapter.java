            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot singleSnapshot: dataSnapshot.getChildren()){
                    Log.d(TAG, "onDataChange: found user: " +
                            singleSnapshot.getValue(UserModel.class).toString());

                    Glide.with(holder.profileImage.getContext()).load(singleSnapshot.getValue(UserModel.class).getProfileImageUrl()).into((holder).profileImage);
                }
            }
